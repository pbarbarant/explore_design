...
pe_df = estimator.fit_predict(events)
...
_stem(ax, trials, pe_A.values, COL_A, "Surprise — option A")
_stem(ax, trials, pe_B.values, COL_B, "Surprise — option B", zorder=3)
